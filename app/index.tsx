        ...
        <View style={styles.containter}>
            {assets && 
                ...
                <View style={styles.buttons}>
                    <Link href={'/login'} style={[defaultStyles.pillButton, {flex:1, backgroundColor: Colors.wombleGreen}]} asChild>
                        <TouchableOpacity>
                            <Text style={{ color: 'white', fontSize: 22, fontWeight: '500' }}> Login</Text>
                        </TouchableOpacity>
                    </Link>

                    <Link href={'/signup'} style={[defaultStyles.pillButton, {flex:1, backgroundColor: Colors.wombleGrey}]} asChild>
                        <TouchableOpacity>
